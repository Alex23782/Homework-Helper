    ...
    const keys = {}, smokeParticles = [], skidMarks = [];
    ...
    function init() {
      ...
      trackShape.bezierCurveTo(100, 50, 100, -50, 0, -50);
      trackShape.bezierCurveTo(-100, -50, -100, 50, 0, 50);
      ...
      const trackTexture = new THREE.TextureLoader().load('https://threejs.org/examples/textures/brick_diffuse.jpg');
      trackTexture.wrapS = trackTexture.wrapT = THREE.RepeatWrapping;
      trackTexture.repeat.set(1, 1);

      const track = new THREE.Mesh(trackGeometry, new THREE.MeshStandardMaterial({ map: trackTexture }));
